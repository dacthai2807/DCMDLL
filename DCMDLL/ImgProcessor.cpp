...
bool ImgProcessor::rotateImage(const char *inputFilename, const char *outputFilename, const signed int degree) {
	...
	if (!di->rotateImage(degree)) return false;
...
bool ImgProcessor::convertToBMPFile(const char *inputFilename, const char *outputFilename) {
...
bool ImgProcessor::applyExistingVOIWindows(const char *inputFilename, const char *outputFilename, const signed int numOfWindows, const VOI_LUT_FUNCTION voiLutFunc) {
...
bool ImgProcessor::applyMinMaxVOIWindows(const char *inputFilename, const char *outputFilename, const VOI_LUT_FUNCTION voiLutFunc) {
...
bool ImgProcessor::applyHistogramVOIWindows(const char *inputFilename, const char *outputFilename, const signed int ignoringPercent, const VOI_LUT_FUNCTION voiLutFunc) {
...
bool ImgProcessor::applySettingVOIWindows(const char *inputFilename, const char *outputFilename, const float center, const float width, const VOI_LUT_FUNCTION voiLutFunc) {
